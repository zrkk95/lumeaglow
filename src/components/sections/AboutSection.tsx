        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed mb-8">
              <p>
                Fondée sur la passion d'apporter la beauté paisible de l'océan dans les espaces du quotidien, LumeaGlow est devenue une marque innovante en matière de solutions d'éclairage d'ambiance.
              </p>
              <p>
