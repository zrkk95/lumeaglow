...
const paymentMethods = [
  ...
  { name: 'PayPal', src: '/assets/payment/paypal.svg' },
  { name: 'Apple Pay', src: '/assets/payment/apple.svg' },
  { name: 'Google Pay', src: '/assets/payment/googlepay.svg' },
];
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              {paymentMethods.map((pm) => (
                <div
                  key={pm.name}
                  className="h-8 px-2 bg-white rounded-md flex items-center justify-center"
                >
                  <img
                    src={pm.src}
                    alt={pm.name}
